...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      FormVoyagePage1: path.resolve(__dirname, 'src/components/Forms/FormVoyagePage1.jsx'),
      FormVoyagePage2: path.resolve(__dirname, 'src/components/Forms/FormVoyagePage2.jsx'),
    },
    extensions: ['.js', '.jsx'],
  },
  module: {
