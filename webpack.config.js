...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      CreateNewVessel: path.resolve(__dirname, 'src/components/Forms/CreateNewVessel.jsx'),
      FormPeople: path.resolve(__dirname, 'src/components/Forms/FormPeople.jsx'),
      CreateNewPerson: path.resolve(__dirname, 'src/components/Forms/CreateNewPerson.jsx'),
