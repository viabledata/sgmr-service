const pleasureCraftValidationRules = {
  page1: [
    ...
    },
    {
      ...
      type: 'required',
      message: 'You must select a pleasure craft type',
    },
    {
      inputField: 'other-input',
      errorDisplayId: 'vesselTypeOther',
      visibilityIndicator: '',
  ...
  page2: [
    ...
    {
      inputField: 'vesselNationality',
      errorDisplayId: 'vesselNationality',
      visibilityIndicator: 'registrationYes',
      type: 'requiredOnVisible',
